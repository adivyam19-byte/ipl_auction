...
def insert_players():
    ...
    if count == 0:
        ...
        ("Axar Patel","DC","All-rounder",8500000),
        ("Kuldeep Yadav","DC","Bowler",7000000),
        ("Prithvi Shaw","DC","Batter",6500000),
        ("Tim David","MI","All-rounder",7500000),
        ("Suryakumar Yadav","MI","Batter",9000000),
        ("Ishan Kishan","MI","Wicketkeeper",8500000),
        ("Arshdeep Singh","PBKS","Bowler",7000000),
        ("Shikhar Dhawan","PBKS","Batter",8000000),
        ("Liam Livingstone","PBKS","All-rounder",9000000),
        ("Kagiso Rabada","PBKS","Bowler",8500000),

        ("Faf du Plessis","RCB","Batter",9000000),
        ("Dinesh Karthik","RCB","Wicketkeeper",7000000),
        ("Wanindu Hasaranga","RCB","All-rounder",8500000),
        ("Ruturaj Gaikwad","CSK","Batter",8500000),
        ("Ben Stokes","CSK","All-rounder",9500000),
        ("Kane Williamson","GT","Batter",8000000),
        ("Rashid Khan","GT","Bowler",9000000),
        ("David Miller","GT","Batter",8500000),
        ("Mohit Sharma","GT","Bowler",6000000),
        ("Wriddhiman Saha","GT","Wicketkeeper",6500000)
